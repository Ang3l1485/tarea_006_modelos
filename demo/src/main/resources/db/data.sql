...
VALUES ('Evaluación inicial', 'Paciente con sobrepeso leve. IMC: 27.5', '2023-01-15 10:30:00', 'Evaluación', 1, 1);

INSERT INTO nota (titulo, contenido, fecha_creacion, tipo_nota, paciente_id, nutricionista_id)
VALUES ('Plan alimenticio', 'Dieta hipocalórica con restricción moderada de carbohidratos', '2023-01-15 11:00:00', 'Plan', 1, 1);
